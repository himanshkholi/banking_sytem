...
class welcomeScreen:
    def __init__(self, window=None):
        ...
        window.title("Welcome to Penny Processors")
        p1 = PhotoImage(file='./images/bank1.png')
        window.iconphoto(True, p1)
        window.configure(background="#464866")
        window.configure(cursor="arrow")

        self.Canvas1 = tk.Canvas(window, background="#25274D", borderwidth="0", insertbackground="black",
                                 relief="ridge",
                                 selectbackground="blue", selectforeground="white")
        self.Canvas1.place(relx=0.190, rely=0.228, relheight=0.496, relwidth=0.622)

        self.Button1 = tk.Button(self.Canvas1, command=self.yes, activebackground="#2E9CCA",
                                 activeforeground="#000000", background="#2E9CCA", disabledforeground="#a3a3a3",
                                 foreground="#fbfbfb", borderwidth="0", highlightbackground="#2E9CCA",
        ...
        self.Button2 = tk.Button(self.Canvas1, command=self.no, activebackground="#2E9CCA",
                                 activeforeground="#000000", background="#2E9CCA", disabledforeground="#a3a3a3",
        ...
        self.Label1 = tk.Label(self.Canvas1, background="#AAABB8", disabledforeground="#a3a3a3",
                               font="-family {Segoe UI} -size 13 -weight bold", foreground="#000000",
                               text='''WELCOME!\nAre you new here?''')
        self.Label1.place(relx=0.241, rely=0.224, height=71, width=194)
    def yes(self):
        self.master.withdraw()
        yes(Toplevel(self.master))
    def no(self):
        self.master.withdraw()
        no(Toplevel(self.master))
...
class yes:
    def __init__(self, window=None):
        ...
        self.Button1 = tk.Button(self.Canvas1, command=self.goback, activebackground="#ececec",
                                 ...
                                 text='''Back''')
        self.Button1.configure(font="-family {Segoe UI} -size 10 -weight bold")
        self.Button1.place(relx=0.35, rely=0.789, height=24, width=130)
        self.Button2 = tk.Button(self.Canvas1, command=self.createCustaccount, activebackground="#ececec",
                                 activeforeground="#000000", background="#023047", disabledforeground="#a3a3a3",
                                 foreground="#f9f9f9", borderwidth="0", highlightbackground="#d9d9d9",
                                 highlightcolor="black", pady="0",
                                 text='''Create new account''')
       
        self.Button2.place(relx=0.35, rely=0.583, height=24, width=130)

        self.Label1 = tk.Label(self.Canvas1, background="#ffff00", disabledforeground="#a3a3a3",
                               font="-family {Segoe UI} -size 13 -weight bold", foreground="#000000",
                               text='''Create a new account \nto start banking: ''')
        self.Label1.place(relx=0.25, rely=0.09, height=71, width=194)
...
class adminLogin:
    def __init__(self, window=None):
        ...
        window.resizable(0, 0)
        window.title("Admin")
        window.configure(background="#29648A")
        ...
        self.Button = tk.Button(Canvas1, text="Login", borderwidth="0", width=10, background="#29648A",
                                foreground="#AAABB8",
                                font="-family {Segoe UI} -size 10 -weight bold",
                                command=lambda: self.login(self.Entry1.get(), self.Entry1_1.get()))
        self.Button.place(relx=0.765, rely=0.755)

        self.Button_back = tk.Button(Canvas1, text="Back", borderwidth="0", width=10, background="#29648A",
                                     foreground="#AAABB8",
                                     font="-family {Segoe UI} -size 10 -weight bold",
                                     command=self.back)
...
class adminMenu:
    def __init__(self, window=None):
        ...
        window.configure(background="#AAABB8")
        ...
        self.Button2 = tk.Button(self.Labelframe1, activebackground="#ececec", activeforeground="#000000",
                                 ...
                                 command=self.exit)
        self.Button2.place(relx=0.667, rely=0.683, height=34, width=181, bordermode='ignore')
        ...
        self.Button3.place(relx=0.04, rely=0.683, height=34, width=181, bordermode='ignore')
        ...
        self.Button4.place(relx=0.04, rely=0.195, height=34, width=181, bordermode='ignore')
        ...
        self.Button6.place(relx=0.353, rely=0.439, height=34, width=181, bordermode='ignore')
